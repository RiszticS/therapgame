...
public class Player : MonoBehaviour
{
    ...
    public List<Ownable> currentOwnables = new List<Ownable>();
    ...
    // Pénz
    private int accountBalance = 150000;
    ...
    {   
        ...
        for (int i = 0; i < spaces; i++)
        {
            ...
            // Elforgatja a bábut ha a tábla sárkára ért 
